...
## 📂 Структура репозитория
  ...
  ├── SQL_pipeline.ipynb # ETL-пайплайн (OCR + GSheets) 
  ├── schema.sql # SQL-код для создания всех таблиц (Схема БД) 
  ├── .gitignore # Игнорируемые файлы (ключи, кэш) └── LICENSE # Лицензия MIT
